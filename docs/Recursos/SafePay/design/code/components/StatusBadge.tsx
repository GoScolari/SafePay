 ...
 * SafePay · StatusBadge
 *
 * Pill que traduce un `TxStatus` a su tono (color + label) usando `StatusTones`.
 * Primitivo — sin lógica condicional fuera. Si `status` no está mapeado,
 * cae al tono EXPIRADO (gris neutro).
 *
 * Uso:
 *   <StatusBadge status="EN_TRANSITO" />
 *   <StatusBadge status="PAGADO" size="sm" />
 */
...
/** Helper: agrega alpha a un hex `#RRGGBB`. Si recibe rgba/otra cosa, lo devuelve tal cual. */
